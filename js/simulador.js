const jugadoresBase = [
    { nombre: 'Chama', ranking: 198, winRate: 0.69, promedioGoles: 6.47 },
    { nombre: 'Facu', ranking: 126, winRate: 0.50, promedioGoles: 5.92 },
    { nombre: 'Tomy', ranking: 118, winRate: 0.63, promedioGoles: 6.54 },
    { nombre: 'Marco', ranking: 76, winRate: 0.60, promedioGoles: 6.1 },
    { nombre: 'Lucas', ranking: 50, winRate: 1.00, promedioGoles: 5.75 },
    { nombre: 'Rafa', ranking: 35, winRate: 0.50, promedioGoles: 5.42 },
    { nombre: 'Pedro', ranking: 21, winRate: 0.50, promedioGoles: 5.67 },
    { nombre: 'Hector', ranking: 20, winRate: 0.17, promedioGoles: 4.67 }
];

const nuevosJugadores = [
    { nombre: 'Mateo', ranking: 17, winRate: 0.50, promedioGoles: 5.0 },
    { nombre: 'Santi', ranking: 5, winRate: 0.25, promedioGoles: 4.77 },
